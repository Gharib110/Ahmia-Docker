...
privoxy_base_config="./torfleet/privoxy_configs/config"

# Create data and log directories if they don't exist
mkdir -p "./torfleet/data/tor"
mkdir -p "./torfleet/pids"
mkdir -p "./torfleet/log"
...
do
	...
	privoxy_conf="./torfleet/privoxy_configs/config_$http_port"
	...
	privoxy $privoxy_conf > ./torfleet/log/privoxy_$i.log 2>&1 &
	sleep 1
